...
namespace arb::EMC_catalogue::kernel_adex {
...
extern "C" {
arb_mechanism_interface* make_arb_EMC_catalogue_adex_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::EMC_catalogue::kernel_adex::simd_width_;
    result.backend=arb_backend_kind_cpu;
    result.alignment=1;
    result.init_mechanism  = (arb_mechanism_method)arb::EMC_catalogue::kernel_adex::init;
    result.compute_currents= (arb_mechanism_method)arb::EMC_catalogue::kernel_adex::compute_currents;
    result.apply_events    = (arb_mechanism_method_events)arb::EMC_catalogue::kernel_adex::apply_events;
    result.advance_state   = (arb_mechanism_method)arb::EMC_catalogue::kernel_adex::advance_state;
    result.write_ions      = (arb_mechanism_method)arb::EMC_catalogue::kernel_adex::write_ions;
    result.post_event      = (arb_mechanism_method)arb::EMC_catalogue::kernel_adex::post_event;
    return &result;
}}
