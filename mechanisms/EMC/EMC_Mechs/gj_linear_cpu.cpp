...
namespace arb::EMC_catalogue::kernel_gj_linear {
...
extern "C" {
  arb_mechanism_interface* make_arb_EMC_catalogue_gj_linear_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::EMC_catalogue::kernel_gj_linear::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::EMC_catalogue::kernel_gj_linear::min_align_;
    result.init_mechanism = arb::EMC_catalogue::kernel_gj_linear::init;
    result.compute_currents = arb::EMC_catalogue::kernel_gj_linear::compute_currents;
    result.apply_events = arb::EMC_catalogue::kernel_gj_linear::apply_events;
    result.advance_state = arb::EMC_catalogue::kernel_gj_linear::advance_state;
    result.write_ions = arb::EMC_catalogue::kernel_gj_linear::write_ions;
    result.post_event = arb::EMC_catalogue::kernel_gj_linear::post_event;
    return &result;
  }}
