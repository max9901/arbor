...
void mechanism_gj_linear_gpu_init_(arb_mechanism_ppack* p) {}

void mechanism_gj_linear_gpu_compute_currents_(arb_mechanism_ppack* p) {
    auto n = p->width;
...
void mechanism_gj_linear_gpu_advance_state_(arb_mechanism_ppack* p) {}

void mechanism_gj_linear_gpu_write_ions_(arb_mechanism_ppack* p) {}

void mechanism_gj_linear_gpu_post_event_(arb_mechanism_ppack* p) {}
void mechanism_gj_linear_gpu_apply_events_(arb_mechanism_ppack* p, arb_deliverable_event_stream* events) {}
