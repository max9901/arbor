...
namespace arb::EMC_catalogue::kernel_linear_gj {
...
arb_mechanism_interface* make_arb_EMC_catalogue_linear_gj_interface_multicore() {
    ...
    result.partition_width = arb::EMC_catalogue::kernel_linear_gj::simd_width_;
    result.backend=arb_backend_kind_cpu;
    result.alignment=1;
    result.init_mechanism  = (arb_mechanism_method)arb::EMC_catalogue::kernel_linear_gj::init;
    result.compute_currents= (arb_mechanism_method)arb::EMC_catalogue::kernel_linear_gj::compute_currents;
    result.apply_events    = (arb_mechanism_method_events)arb::EMC_catalogue::kernel_linear_gj::apply_events;
    result.advance_state   = (arb_mechanism_method)arb::EMC_catalogue::kernel_linear_gj::advance_state;
    result.write_ions      = (arb_mechanism_method)arb::EMC_catalogue::kernel_linear_gj::write_ions;
    result.post_event      = (arb_mechanism_method)arb::EMC_catalogue::kernel_linear_gj::post_event;
    return &result;
}}
