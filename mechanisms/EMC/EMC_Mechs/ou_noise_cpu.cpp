...
namespace arb::EMC_catalogue::kernel_ou_noise {
...
extern "C" {
  arb_mechanism_interface* make_arb_EMC_catalogue_ou_noise_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::EMC_catalogue::kernel_ou_noise::simd_width_;
    result.backend=arb_backend_kind_cpu;
    result.alignment=1;
    result.init_mechanism  = (arb_mechanism_method)arb::EMC_catalogue::kernel_ou_noise::init;
    result.compute_currents= (arb_mechanism_method)arb::EMC_catalogue::kernel_ou_noise::compute_currents;
    result.apply_events    = (arb_mechanism_method_events)arb::EMC_catalogue::kernel_ou_noise::apply_events;
    result.advance_state   = (arb_mechanism_method)arb::EMC_catalogue::kernel_ou_noise::advance_state;
    result.write_ions      = (arb_mechanism_method)arb::EMC_catalogue::kernel_ou_noise::write_ions;
    result.post_event      = (arb_mechanism_method)arb::EMC_catalogue::kernel_ou_noise::post_event;
    return &result;
  }}
