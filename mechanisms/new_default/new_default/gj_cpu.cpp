...
static void init(arb_mechanism_ppack* pp) {
    std::cout << "GJHITHIT i'm the new default " <<  std::endl;
}
...
extern "C" {
  arb_mechanism_interface* make_arb_new_default_catalogue_gj_interface_multicore() {
    ...
    result.partition_width = arb::new_default_catalogue::kernel_gj::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::new_default_catalogue::kernel_gj::min_align_;
    result.init_mechanism = arb::new_default_catalogue::kernel_gj::init;
    result.compute_currents = arb::new_default_catalogue::kernel_gj::compute_currents;
    result.apply_events = arb::new_default_catalogue::kernel_gj::apply_events;
    result.advance_state = arb::new_default_catalogue::kernel_gj::advance_state;
    result.write_ions = arb::new_default_catalogue::kernel_gj::write_ions;
    result.post_event = arb::new_default_catalogue::kernel_gj::post_event;
    return &result;
  }}
