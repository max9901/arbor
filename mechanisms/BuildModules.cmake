...
function("make_catalogue")
    cmake_parse_arguments(MK_CAT "" "NAME;SOURCES;OUTPUT;PREFIX;STANDALONE;VERBOSE;CXXIN" "CXX_FLAGS_TARGET;MECHS" ${ARGN})
    ...
    if(MK_CAT_CXXIN)
        #  todo copy and check cpp files here
        set(MK_CAT_OUT_DIR ${MK_CAT_SOURCES})
        add_custom_target(build_catalogue_${MK_CAT_NAME}_mods)
    else()
